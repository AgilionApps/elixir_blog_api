defmodule JsonApi.Params do

  defmacro __using__(_) do
    quote do
      import JsonApi.Params, only: [filter_params: 3, filter_params: 2]
    end
  end

  defmacro filter_params(conn, allow, do: block) do
    quote do
      var!(params) = JsonApi.Params.filter_params(unquote(conn), unquote(allow))
      unquote(block)
    end
  end
